...
function agregarUsuario() {
    ...
    const inpArea = document.getElementById('input-area').value
    ...
    btnEditar.onclick = function() {
        ...
        document.getElementById('input-area').value = usuario.area
...
function editarUsuario() {
    ...
    trId.childNodes[3].textContent = document.getElementById("input-area").value
